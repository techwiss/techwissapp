...
'https://cdnjs.cloudflare.com/ajax/libs/angular.js/1.3.15/angular-resource.min.js',
        ...
        'public/lib/plugins/angular-route.min.js',
        'public/lib/plugins/angular-aria.min.js',
        'public/lib/plugins/ui-bootstrap-tpls.min.js',
        'public/lib/plugins/angular-material.min.js',
        'public/lib/plugins/ocLazyLoad.min.js',
        'public/lib/plugins/loading-bar.min.js',
        'public/lib/plugins/angular-fullscreen.js',
        'public/lib/plugins/perfect-scrollbar.min.js',
